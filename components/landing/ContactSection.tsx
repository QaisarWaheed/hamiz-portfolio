...
const FIELD_CLASS =
  "w-full border border-line/40 bg-transparent px-4 py-3 text-base text-paper placeholder:text-paper/40 focus:border-paper/70 focus:outline-none";
        ...
        <SectionReveal delay={0.1} className="mt-12 max-w-xl">
          <form className="flex flex-col gap-4" onSubmit={(e) => void onSubmit(e)}>
            ...
            <button
              ...
              className="mt-2 inline-flex w-full items-center justify-center bg-paper px-6 py-3 text-xs uppercase tracking-[0.18em] text-ink transition-opacity hover:opacity-90 disabled:opacity-60 sm:w-auto"
            >
              {buttonLabel}
            </button>
            {status === "success" ? (
